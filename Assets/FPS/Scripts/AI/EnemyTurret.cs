...
namespace Unity.FPS.AI
{
    ...
    public class EnemyTurret : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            DebugUtility.HandleErrorIfNullGetComponent<EnemyBrain, EnemyTurret>(m_EnemyBrain, this,
                gameObject);
            ...
            m_RotationWeaponForwardToPivot =
                Quaternion.Inverse(m_EnemyBrain.CurrentWeapon.WeaponMuzzle.rotation) * TurretPivot.rotation;
            ...
            switch (AiState)
            {
                case AIState.Attack:
                    ...
                    Vector3 directionToTarget =
                        (m_EnemyBrain.DetectionModule.KnownDetectedTarget.transform.position - TurretAimPoint.position).normalized;
                    ...
                    if (mustShoot)
                    {
                        ...
                        m_EnemyBrain.TryAttack(TurretAimPoint.position + correctedDirectionToTarget);
                    }
