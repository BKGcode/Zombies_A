...
{
    [CreateAssetMenu(fileName = "FeederConfig", menuName = "Gallinas Felices/Structure Configs/Feeder Config")]
    public class FeederConfigSO : ScriptableObject
    {
        [Header("Level Info")]
        ...
        [Header("Capacity")]
        [Tooltip("Capacidad máxima de comida")]
        [Range(50f, 500f)]
        public float capacity = 100f;
        
        [Header("Usage Limits")]
        [Tooltip("Máximo de gallinas que pueden comer simultáneamente")]
        [Range(1, 20)]
        ...
        public FeederConfigSO nextLevel;
